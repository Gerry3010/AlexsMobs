...
public class AlexsMobs {
    ...
    public AlexsMobs(IEventBus modBusEvent, ModContainer modContainer) {
        ...
        final DeferredRegister<Codec<? extends BiomeModifier>> biomeModifiers = DeferredRegister.create(Neonet.minecraft.core.registries.BuiltInRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, AlexsMobs.MODID);
        ...
        final DeferredRegister<Codec<? extends StructureModifier>> structureModifiers = DeferredRegister.create(Neonet.minecraft.core.registries.BuiltInRegistries.Keys.STRUCTURE_MODIFIER_SERIALIZERS, AlexsMobs.MODID);
