...
public class AMLeafcutterAntBiomeModifier implements BiomeModifier {
    private static final DeferredHolder<Codec<? extends BiomeModifier>, Codec<? extends BiomeModifier>> SERIALIZER = DeferredHolder.create(Neonet.minecraft.core.registries.BuiltInRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, ResourceLocation.fromNamespaceAndPath(AlexsMobs.MODID, "am_leafcutter_ant_spawns"));
