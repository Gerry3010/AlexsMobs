...
public class ModelRaccoon extends AdvancedEntityModel<EntityRaccoon> {
    ...
    public void setupAnim(EntityRaccoon entityRaccoon, float limbSwing, float limbSwingAmount, float ageInTicks, float v3, float v4) {
        ...
        progressRotationPrev(body, standProgress, Maths.rad(-70), 0, 0, 5f);
        progressRotationPrev(arm_left, standProgress, Maths.rad(70), 0, 0, 5f);
        progressRotationPrev(arm_right, standProgress, Maths.rad(70), 0, 0, 5f);
        progressRotationPrev(leg_left, standProgress, Maths.rad(70), 0, 0, 5f);
        ...
        progressRotationPrev(body, normalProgress, Maths.rad(10), 0, 0, 5f);
        progressRotationPrev(head, normalProgress, Maths.rad(-10), 0, 0, 5f);
        progressRotationPrev(arm_left, normalProgress, Maths.rad(-10), 0, 0, 5f);
        progressRotationPrev(arm_right, normalProgress, Maths.rad(-10), 0, 0, 5f);
        progressRotationPrev(leg_left, normalProgress, Maths.rad(-10), 0, 0, 5f);
        progressRotationPrev(leg_right, normalProgress, Maths.rad(-10), 0, 0, 5f);
        ...
        progressRotationPrev(tail, 5F - runProgress, Maths.rad(-35), 0, 0, 5f);
        progressRotationPrev(tail, runProgress, Maths.rad(-10), 0, 0, 5f);
        progressRotationPrev(ear_left, Math.max(runProgress, begProgress), Maths.rad(-20), 0, Maths.rad(20), 5f);
        progressRotationPrev(ear_right, Math.max(runProgress, begProgress), Maths.rad(-20), 0, Maths.rad(-20), 5f);
        progressRotationPrev(arm_right, begProgress, Maths.rad(-25), 0, 0, 5f);
        progressRotationPrev(arm_left, begProgress, Maths.rad(-25), 0, 0, 5f);
        if (begProgress > 0) {
        ...
        progressRotationPrev(body, washProgress, Maths.rad(15), 0, 0, 5f);
        progressRotationPrev(arm_left, washProgress, Maths.rad(-90), 0, 0, 5f);
        progressRotationPrev(arm_right, washProgress, Maths.rad(-90), 0, 0, 5f);
        progressRotationPrev(leg_left, washProgress, Maths.rad(-15), 0, 0, 5f);
        progressRotationPrev(leg_right, washProgress, Maths.rad(-15), 0, 0, 5f);
        progressRotationPrev(tail, washProgress, Maths.rad(-15), 0, 0, 5f);
        progressRotationPrev(head, washProgress, Maths.rad(15), 0, 0, 5f);
