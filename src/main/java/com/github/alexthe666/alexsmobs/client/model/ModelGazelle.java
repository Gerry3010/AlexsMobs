...
public class ModelGazelle extends AdvancedEntityModel<EntityGazelle> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.rotate(tail, 0, 0, Maths.rad(50));
        ...
        animator.startKeyframe(2);
        animator.rotate(neck, Maths.rad(25), Maths.rad(20), 0);
        animator.rotate(head, Maths.rad(5), 0, Maths.rad(10));
        animator.rotate(body, 0, Maths.rad(5), 0);
        animator.rotate(earR, 0, Maths.rad(25), Maths.rad(40));
        animator.rotate(earL, 0, Maths.rad(-25), Maths.rad(-40));
        animator.endKeyframe();
        animator.startKeyframe(2);
        animator.rotate(neck, Maths.rad(25), Maths.rad(-20), 0);
        animator.rotate(head, Maths.rad(5), 0, Maths.rad(-10));
        ...
        animator.rotate(head, Maths.rad(5), 0, Maths.rad(10));
        animator.rotate(body, 0, Maths.rad(5), 0);
        animator.rotate(earR, 0, Maths.rad(5), Maths.rad(-40));
        animator.rotate(earL, 0, Maths.rad(-5), Maths.rad(40));
        animator.endKeyframe();
        animator.startKeyframe(2);
        animator.rotate(neck, Maths.rad(25), Maths.rad(-20), 0);
        animator.rotate(head, Maths.rad(5), 0, Maths.rad(-10));
        ...
        animator.rotate(neck, Maths.rad(120), 0, 0);
    ...
    private void eatPose(){
        ...
        animator.rotate(backlegL, Maths.rad(-10), 0, 0);
        animator.rotate(backlegR, Maths.rad(-10), 0, 0);
        animator.rotate(frontlegL, Maths.rad(-10), 0, 0);
        animator.rotate(frontlegR, Maths.rad(-10), 0, 0);
