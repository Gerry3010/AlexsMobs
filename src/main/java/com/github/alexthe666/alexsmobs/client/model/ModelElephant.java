...
public class ModelElephant extends AdvancedEntityModel<EntityElephant> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.rotate(left_ear, 0, Maths.rad(25), 0);
        animator.rotate(right_ear, 0, Maths.rad(-25), 0);
        animator.rotate(trunk1, Maths.rad(-65), 0, 0);
        animator.rotate(trunk2, Maths.rad(-35), 0, 0);
        animator.move(trunk2, 0,  -2, 0);
        animator.endKeyframe();
        animator.startKeyframe(5);
        animator.rotate(head, Maths.rad(-35), 0, 0);
        animator.rotate(left_ear, 0, Maths.rad(45), 0);
        animator.rotate(right_ear, 0, Maths.rad(-45), 0);
        animator.rotate(trunk1, Maths.rad(-75), 0, 0);
        animator.rotate(trunk2, Maths.rad(-55), 0, 0);
        ...
        animator.startKeyframe(5);
        animator.rotate(head, Maths.rad(-25), 0, Maths.rad(-25));
        animator.rotate(left_ear, 0, Maths.rad(25), 0);
        animator.rotate(right_ear, 0, Maths.rad(-25), 0);
        animator.rotate(trunk1, Maths.rad(-75), Maths.rad(25), 0);
        animator.rotate(trunk2, Maths.rad(-35), Maths.rad(10), 0);
        animator.move(trunk2, 0,  -2, 0);
        animator.endKeyframe();
        animator.startKeyframe(5);
        animator.rotate(head, Maths.rad(-25), 0, Maths.rad(25));
        ...
        animator.rotate(body, Maths.rad(15), 0, 0);
        animator.rotate(head, Maths.rad(-30), 0, 0);
        animator.rotate(right_ear, 0, Maths.rad(-20), 0);
        animator.rotate(left_ear, 0, Maths.rad(20), 0);
        animator.rotate(left_arm, Maths.rad(-15), 0, Maths.rad(-15));
        animator.rotate(right_arm, Maths.rad(-15), 0, Maths.rad(15));
        animator.rotate(left_leg, Maths.rad(-15), 0, 0);
        animator.rotate(right_leg, Maths.rad(-15), 0, 0);
        animator.rotate(trunk1, Maths.rad(-15), 0, 0);
        animator.rotate(trunk2, Maths.rad(45), 0, 0);
        ...
        animator.rotate(left_leg, Maths.rad(35), 0, 0);
        animator.rotate(right_leg, Maths.rad(35), 0, 0);
        animator.rotate(left_arm, Maths.rad(35), Maths.rad(-15), 0);
        animator.rotate(right_arm, Maths.rad(35), Maths.rad(15), 0);
        animator.rotate(trunk1, Maths.rad(-15), 0, 0);
        animator.rotate(trunk2, Maths.rad(45), 0, 0);
        animator.rotate(tail, Maths.rad(45), 0, 0);
        animator.move(body, 0,  -6, 0);
        animator.move(trunk2, 0,  -2, 0);
        animator.move(left_leg, 0,  -1, 0);
        animator.move(right_leg, 0,  -1, 0);
        ...
        animator.rotate(left_ear, 0, Maths.rad(25), 0);
        animator.rotate(right_ear, 0, Maths.rad(-25), 0);
        animator.rotate(trunk1, Maths.rad(10), 0, 0);
        animator.rotate(trunk2, Maths.rad(15), 0, 0);
        animator.move(head, 0,  3, 0);
        animator.endKeyframe();
        animator.startKeyframe(5);
        animator.move(head, 0,  -2, -1);
        animator.rotate(head, Maths.rad(-45), 0, 0);
        animator.rotate(left_ear, 0, Maths.rad(25), 0);
        animator.rotate(right_ear, 0, Maths.rad(-25), 0);
        animator.rotate(trunk1, Maths.rad(-55), 0, 0);
        animator.rotate(trunk2, Maths.rad(-55), 0, 0);
        animator.move(trunk2, 0,  -2, 0);
        animator.endKeyframe();
        ...
        animator.rotate(head, Maths.rad(10), 0, 0);
        animator.rotate(trunk1, Maths.rad(-45), 0, 0);
        animator.rotate(trunk2, Maths.rad(120), 0, 0);
        ...
        animator.rotate(left_ear, 0, Maths.rad(5), 0);
        animator.rotate(right_ear, 0, Maths.rad(-5), 0);
        animator.rotate(trunk1, Maths.rad(-40), 0, 0);
        animator.rotate(trunk2, Maths.rad(-60), 0, 0);
        animator.move(trunk2, 0,  -2, 0);
        animator.endKeyframe();
        animator.setStaticKeyframe(5);
        animator.resetKeyframe(5);
    ...
    public void setupAnim(EntityElephant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(left_arm, standProgress, Maths.rad(60),  Maths.rad(-10), 0, 5F);
        progressRotationPrev(right_leg, standProgress, Maths.rad(60),  Maths.rad(-15), 0, 5F);
        progressRotationPrev(left_leg, standProgress, Maths.rad(60),  Maths.rad(15), 0, 5F);
        ...
        progressRotationPrev(right_arm, sitProgress, Maths.rad(-90),  Maths.rad(10), 0, 5F);
        progressRotationPrev(left_arm, sitProgress, Maths.rad(-90),  Maths.rad(-10), 0, 5F);
        progressRotationPrev(right_leg, sitProgress, Maths.rad(90),  Maths.rad(5), 0, 5F);
        progressRotationPrev(left_leg, sitProgress, Maths.rad(90),  Maths.rad(-5), 0, 5F);
        ...
        progressRotationPrev(trunk1, sitProgress,Maths.rad(-45),  0, 0, 5F);
        progressRotationPrev(trunk2, sitProgress,Maths.rad(60),  0, 0, 5F);
