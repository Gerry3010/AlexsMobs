...
public class RenderEnderiophage extends MobRenderer<EntityEnderiophage, ModelEnderiophage> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/enderiophage.png");
    private static final ResourceLocation TEXTURE_GLOW = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/enderiophage_glow.png");
    private static final ResourceLocation TEXTURE_OVERWORLD = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/enderiophage_overworld.png");
    private static final ResourceLocation TEXTURE_OVERWORLD_GLOW = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/enderiophage_overworld_glow.png");
    private static final ResourceLocation TEXTURE_NETHER = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/enderiophage_nether.png");
    private static final ResourceLocation TEXTURE_NETHER_GLOW = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/enderiophage_nether_glow.png");
