...
public class RenderVoidWormBody extends LivingEntityRenderer<EntityVoidWormPart, EntityModel<EntityVoidWormPart>> {
    private static final ResourceLocation TEXTURE_BODY = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/void_worm/void_worm_body.png");
    private static final ResourceLocation TEXTURE_BODY_HURT = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/void_worm/void_worm_body_hurt.png");
    private static final ResourceLocation TEXTURE_BODY_GLOW = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/void_worm/void_worm_body_glow.png");
    private static final ResourceLocation TEXTURE_TAIL = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/void_worm/void_worm_tail.png");
    private static final ResourceLocation TEXTURE_TAIL_HURT = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/void_worm/void_worm_tail_hurt.png");
    private static final ResourceLocation TEXTURE_TAIL_GLOW = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/void_worm/void_worm_tail_glow.png");
