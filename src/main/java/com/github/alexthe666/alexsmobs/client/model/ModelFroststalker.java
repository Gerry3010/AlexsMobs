...
public class ModelFroststalker extends AdvancedEntityModel<EntityFroststalker> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.rotate(neck, Maths.rad(-30), 0, 0);
        ...
        animator.rotate(jaw, Maths.rad(25), 0, 0);
        animator.endKeyframe();
        ...
        animator.rotate(neck, Maths.rad(15), Maths.rad(15), 0);
        animator.rotate(legright, Maths.rad(15), Maths.rad(15), 0);
        animator.rotate(legleft, Maths.rad(15), Maths.rad(15), 0);
        animator.rotate(armleft, Maths.rad(-50), 0, Maths.rad(-105));
        animator.endKeyframe();
        animator.startKeyframe(2);
        animator.rotate(neck, Maths.rad(-20), 0, 0);
        animator.rotate(head, Maths.rad(5), 0, 0);
        animator.move(armleft, 0, 0, -2);
        animator.rotate(armleft, Maths.rad(-90), 0, Maths.rad(15));
        animator.endKeyframe();
        animator.resetKeyframe(5);
        ...
        animator.rotate(legright, Maths.rad(15), Maths.rad(-15), 0);
        animator.rotate(legleft, Maths.rad(15), Maths.rad(-15), 0);
        animator.rotate(armright, Maths.rad(-50), 0, Maths.rad(105));
        animator.endKeyframe();
        animator.startKeyframe(2);
        animator.rotate(neck, Maths.rad(-20), 0, 0);
        animator.rotate(head, Maths.rad(5), 0, 0);
        animator.move(armright, 0, 0, -2);
        animator.rotate(armright, Maths.rad(-90), 0, Maths.rad(-15));
        animator.endKeyframe();
        animator.resetKeyframe(5);
        ...
        animator.rotate(legright, Maths.rad(-25), 0, 0);
        animator.rotate(legleft, Maths.rad(-25), 0, 0);
        animator.rotate(neck, Maths.rad(35), 0, 0);
        animator.endKeyframe();
        animator.startKeyframe(2);
        animator.move(body, 0, 0, -7);
        animator.rotate(legright, Maths.rad(25), 0, 0);
        animator.rotate(legleft, Maths.rad(25), 0, 0);
        animator.rotate(neck, Maths.rad(25), 0, 0);
    ...
    public void setupAnim(EntityFroststalker entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(head, bipedProgress, Maths.rad(-30), 0, 0, 5F);
        ...
        progressRotationPrev(tail1, quadProgress, Maths.rad(-20), 0, 0, 5F);
        progressRotationPrev(tail2, quadProgress, Maths.rad(10), 0, 0, 5F);
        ...
        progressRotationPrev(body, tackleProgress, Maths.rad(-45), 0, 0, 5F);
        progressRotationPrev(neck, tackleProgress, Maths.rad(25), 0, 0, 5F);
        progressRotationPrev(head, tackleProgress, Maths.rad(25), 0, 0, 5F);
        progressRotationPrev(armright, tackleProgress, Maths.rad(-50), 0, Maths.rad(40), 5F);
        progressRotationPrev(armleft, tackleProgress, Maths.rad(-50), 0, Maths.rad(-40), 5F);
        progressRotationPrev(legright, tackleProgress, Maths.rad(-10), 0, 0, 5F);
        progressRotationPrev(legleft, tackleProgress, Maths.rad(-10), 0, 0, 5F);
        progressRotationPrev(tail1, tackleProgress, Maths.rad(30), 0, 0, 5F);
        progressRotationPrev(jaw, tackleProgress, Maths.rad(20), 0, 0, 5F);
