...
public class ModelKangaroo extends AdvancedEntityModel<EntityKangaroo> {
	...
	public ModelKangaroo() {
		...
		pouch = new AdvancedModelBox(this, "pouch");
		...
		knee_left = new AdvancedModelBox(this, "knee_left");
		...
		knee_right = new AdvancedModelBox(this, "knee_right");
	...
	public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
		...
		animator.rotate(neck, Maths.rad(100), 0, 0);
		animator.rotate(chest, Maths.rad(10), 0, 0);
		animator.rotate(head, Maths.rad(-20), 0, 0);
		animator.rotate(arm_left, Maths.rad(-20), 0, 0);
		animator.rotate(arm_right, Maths.rad(-20), 0, 0);
		...
		animator.rotate(chest, Maths.rad(10), 0, 0);
		animator.rotate(head, Maths.rad(-20), 0, 0);
		animator.rotate(neck, Maths.rad(-10), 0, 0);
		animator.rotate(arm_left, Maths.rad(-20), 0, 0);
		animator.rotate(arm_right, Maths.rad(-20), 0, 0);
		animator.endKeyframe();
		...
		animator.rotate(tail1, Maths.rad(20), 0, 0);
		animator.rotate(tail2, Maths.rad(20), 0, 0);
		animator.rotate(leg_right, Maths.rad(-10), 0, 0);
		animator.rotate(leg_left, Maths.rad(-10), 0, 0);
		animator.rotate(knee_left, Maths.rad(-40), 0, 0);
		animator.rotate(knee_right, Maths.rad(-40), 0, 0);
		animator.rotate(foot_left, Maths.rad(50), 0, 0);
		animator.rotate(foot_right, Maths.rad(50), 0, 0);
		animator.rotate(arm_right, 0, 0, Maths.rad(-15));
		animator.rotate(arm_left, 0, 0, Maths.rad(15));
		animator.endKeyframe();
		animator.resetKeyframe(3);
		animator.setAnimation(EntityKangaroo.ANIMATION_PUNCH_R);
		animator.startKeyframe(3);
		animator.rotate(chest, Maths.rad(-10), Maths.rad(-30), 0);
		animator.rotate(neck, 0, Maths.rad(30), 0);
		animator.rotate(arm_right, Maths.rad(15), 0, 0);
		animator.rotate(arm_left, Maths.rad(15), 0, 0);
		animator.endKeyframe();
		animator.startKeyframe(3);
		animator.rotate(chest, Maths.rad(10), Maths.rad(-10), 0);
		animator.rotate(neck, 0, Maths.rad(-40), 0);
		animator.rotate(head, 0, Maths.rad(30), 0);
		animator.rotate(arm_right, Maths.rad(-125), 0, 0);
		animator.rotate(arm_left, Maths.rad(15), 0, 0);
		animator.endKeyframe();
		animator.resetKeyframe(5);
		...
		animator.rotate(neck, 0, Maths.rad(-40), 0);
		animator.rotate(head, 0, Maths.rad(30), 0);
		animator.rotate(arm_left, Maths.rad(-125), 0, 0);
		animator.rotate(arm_right, Maths.rad(15), 0, 0);
		animator.endKeyframe();
		animator.resetKeyframe(5);
	}
	...
	public void setupAnim(EntityKangaroo entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		progressRotationPrev(knee_left, sitProgress, Maths.rad(65), 0, 0, 5F);
		progressRotationPrev(knee_right, sitProgress, Maths.rad(65), 0, 0, 5F);
		progressRotationPrev(foot_left, sitProgress, Maths.rad(-65), 0, 0, 5F);
		progressRotationPrev(foot_right, sitProgress, Maths.rad(-65), 0, 0, 5F);
		progressRotationPrev(arm_left, sitProgress, Maths.rad(-15), 0, 0, 5F);
		progressRotationPrev(arm_right, sitProgress, Maths.rad(-15), 0, 0, 5F);
		...
		progressRotationPrev(body, stillProgress, Maths.rad(-35), 0, 0, 5F);
		progressRotationPrev(leg_left, stillProgress, Maths.rad(35), 0, 0, 5F);
		progressRotationPrev(leg_right, stillProgress, Maths.rad(35), 0, 0, 5F);
		progressRotationPrev(chest, stillProgress, Maths.rad(-10), 0, 0, 5F);
		progressRotationPrev(arm_left, stillProgress, Maths.rad(20), 0, 0, 5F);
		progressRotationPrev(arm_right, stillProgress, Maths.rad(20), 0, 0, 5F);
		progressRotationPrev(neck, stillProgress, Maths.rad(35), 0, 0, 5F);
		progressRotationPrev(tail1, stillProgress, Maths.rad(25), 0, 0, 5F);
		progressRotationPrev(tail2, stillProgress, Maths.rad(25), 0, 0, 5F);
