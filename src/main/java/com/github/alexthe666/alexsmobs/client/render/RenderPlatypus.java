...
public class RenderPlatypus extends MobRenderer<EntityPlatypus, ModelPlatypus> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/platypus.png");
    private static final ResourceLocation TEXTURE_PERRY = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/platypus_perry.png");
    ...
    static class FedoraLayer extends RenderLayer<EntityPlatypus, ModelPlatypus> {
        private final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/platypus_fedora.png");
