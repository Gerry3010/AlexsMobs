...
public class RenderGuster extends MobRenderer<EntityGuster, ModelGuster> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/guster.png");
    private static final ResourceLocation TEXTURE_GOOGLY = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/guster_silly.png");
    private static final ResourceLocation TEXTURE_EYES = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/guster_eye.png");
    private static final ResourceLocation TEXTURE_RED = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/guster_red.png");
    private static final ResourceLocation TEXTURE_SOUL = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/guster_soul.png");
    private static final ResourceLocation TEXTURE_SOUL_EYES = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/guster_eye_soul.png");
