...
public class ModelCosmaw extends AdvancedEntityModel<EntityCosmaw> {
    ...
    public ModelCosmaw() {
        ...
        mouthArm1 = new AdvancedModelBox(this, "mouthArm1");
        ...
        mouthArm2 = new AdvancedModelBox(this, "mouthArm2");
        ...
        topJaw = new AdvancedModelBox(this, "topJaw");
        ...
        eyesBase = new AdvancedModelBox(this, "eyesBase");
