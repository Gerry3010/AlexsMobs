...
public class RenderCrocodile extends MobRenderer<EntityCrocodile, ModelCrocodile> {
    private static final ResourceLocation TEXTURE_0 = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/crocodile_0.png");
    private static final ResourceLocation TEXTURE_1 = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/crocodile_1.png");
    private static final ResourceLocation TEXTURE_CROWN = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/crocodile_crown.png");
