...
public class RenderBunfungus extends MobRenderer<EntityBunfungus, ModelBunfungus> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/bunfungus.png");
    private static final ResourceLocation TEXTURE_SLEEPING = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/bunfungus_sleeping.png");
