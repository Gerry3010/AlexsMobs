...
public class RenderKomodoDragon extends MobRenderer<EntityKomodoDragon, ModelKomodoDragon> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/komodo_dragon.png");
    private static final ResourceLocation TEXTURE_SADDLE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/komodo_dragon_saddle.png");
    private static final ResourceLocation TEXTURE_MAID = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/komodo_dragon_maid.png");
    ...
    static class LayerSaddle extends RenderLayer<EntityKomodoDragon, ModelKomodoDragon> {
        ...
        public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, EntityKomodoDragon entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
            if(entitylivingbaseIn.isMaid()){
                ...
                MAID_MODEL.renderToBuffer(matrixStackIn, maid, packedLightIn, LivingEntityRenderer.getOverlayCoords(entitylivingbaseIn, 0.0F));
            }
            if(entitylivingbaseIn.isSaddled()){
                ...
                SADDLE_MODEL.renderToBuffer(matrixStackIn, saddle, packedLightIn, LivingEntityRenderer.getOverlayCoords(entitylivingbaseIn, 0.0F));
            }
        }
    }
}