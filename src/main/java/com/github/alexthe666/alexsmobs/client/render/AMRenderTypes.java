...
public class AMRenderTypes extends RenderType {
    ...
    public static final ResourceLocation STATIC_TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/static.png");
    ...
    public static RenderType getSkulkBoom() {
        CompositeState renderState = CompositeState.builder()
                ...
                .setTextureState(new TextureStateShard(ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/particle/skulk_boom.png"), true, true))
