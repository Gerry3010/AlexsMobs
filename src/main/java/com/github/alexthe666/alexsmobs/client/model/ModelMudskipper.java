...
public class ModelMudskipper extends AdvancedEntityModel<EntityMudskipper> {
    ...
    public void setupAnim(EntityMudskipper entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(head, displayProgress, Maths.rad(-10F), 0F, 0F, 5f);
        progressRotationPrev(tail, displayProgress, Maths.rad(20F), 0F, 0F, 5f);
        progressRotationPrev(dorsalFin, displayProgress, Maths.rad(-10F), 0F, 0F, 5f);
        progressRotationPrev(rightFin, displayProgress, Maths.rad(-10F), 0F, 0F, 5f);
        progressRotationPrev(leftFin, displayProgress, Maths.rad(-10F), 0F, 0F, 5f);
        progressRotationPrev(tailFin, displayProgress, Maths.rad(10F), 0F, 0F, 5f);
        ...
        progressRotationPrev(head, sitProgress, 0F, Maths.rad(-10F), 0F, 5f);
        progressRotationPrev(tail, sitProgress, 0F, Maths.rad(30F), 0F, 5f);
        progressRotationPrev(tailFin, sitProgress, 0F, Maths.rad(10F), 0F, 5f);
        progressRotationPrev(leftFin, sitProgress, 0F, Maths.rad(-20F), 0F, 5f);
