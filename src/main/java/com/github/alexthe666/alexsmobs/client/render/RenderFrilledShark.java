...
public class RenderFrilledShark extends MobRenderer<EntityFrilledShark, ModelFrilledShark> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/frilled_shark.png");
    private static final ResourceLocation TEXTURE_DEPRESSURIZED = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/frilled_shark_depressurized.png");
    private static final ResourceLocation TEXTURE_KAIJU = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/frilled_shark_kaiju.png");
    private static final ResourceLocation TEXTURE_KAIJU_DEPRESSURIZED = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/frilled_shark_kaiju_depressurized.png");
    private static final ResourceLocation TEXTURE_TEETH = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/frilled_shark_teeth.png");
