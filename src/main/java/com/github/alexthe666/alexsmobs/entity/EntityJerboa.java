    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (type != InteractionResult.SUCCESS && !isFood(itemstack) && itemstack.is(AMTagRegistry.JERBOA_BEGS_FOR)) {
            ...
            if (random.nextFloat() <= 0.3F) {
                player.addEffect(new MobEffectInstance(net.minecraft.core.Holder.direct(AMEffectRegistry.FLEET_FOOTED.get()), 12000));
            }
            return InteractionResult.SUCCESS;
        }
        return type;
        ...
        if (prev) {
            ...
            if (source.getEntity() != null) {
                if (source.getEntity() instanceof LivingEntity) {
                    ...
                    if (hurter.hasEffect(net.minecraft.core.Holder.direct(AMEffectRegistry.FLEET_FOOTED.get()))) {
                        hurter.removeEffect(net.minecraft.core.Holder.direct(AMEffectRegistry.FLEET_FOOTED.get()));
                    }
                }
            }
            return prev;
